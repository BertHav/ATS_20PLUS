...
// If separate EEPROM 24c256 or larger is installed with patch-init firmware 
//to get a lot of free program space
#define SSB_PATCH_FROM_EEPROM

//AVR internal EEPROM Settings
